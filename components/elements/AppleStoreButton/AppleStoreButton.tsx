...
const AppleStoreButton: React.FC<{ className?: string }> = ({
  ...
  return (
    <a
      className={`inline-flex items-center w-full max-w-[220px] gap-2 no-underline text-white bg-black border border-white/15 px-2 py-1.5 rounded-md text-sm transition-all duration-120 ease-out hover:-translate-y-px hover:shadow-lg ${className}`}
      href={href}
      target="_blank"
